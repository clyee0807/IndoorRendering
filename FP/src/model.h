    ...
    public:
        ...
        void render(Shader& shader) const {
            for (unsigned int i = 0; i < numMeshes; i++) {
                ...
                glUniform4fv(glGetUniformLocation(shader.ID, "material.Ka"), 1, glm::value_ptr(meshList[i].mats.Ka));
                glUniform4fv(glGetUniformLocation(shader.ID, "material.Kd"), 1, glm::value_ptr(meshList[i].mats.Kd));
